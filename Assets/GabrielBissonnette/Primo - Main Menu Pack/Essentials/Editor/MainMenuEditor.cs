...
public class MainMenuEditor : Editor
{
    ...
    private SerializedProperty playSceneToLoad;
    private SerializedProperty sandBoxSceneToLoad;
    ...
    private SerializedProperty loginPanel;
    private SerializedProperty signUpPanel;
    ...
    private SerializedProperty profileTierText;
    private SerializedProperty profileScoreText;

    private SerializedProperty alertText;
    private SerializedProperty alertBackButton;
    private SerializedProperty alertQuitButton;
    #endregion
    ...
    private void OnEnable()
    {
        ...
        playSceneToLoad = soTarget.FindProperty("playSceneToLoad");
        sandBoxSceneToLoad = soTarget.FindProperty("sandBoxSceneToLoad");
        ...
        loginPanel = soTarget.FindProperty("loginPanel");
        signUpPanel = soTarget.FindProperty("signUpPanel");
        ...
        profileUserNameText = soTarget.FindProperty("profileUserNameText");
        profileTierText = soTarget.FindProperty("profileTierText");
        ...
        alertBackButton = soTarget.FindProperty("alertBackButton");
        alertQuitButton = soTarget.FindProperty("alertQuitButton");
        #endregion
    }
    ...
    private void Values()
    {
        ...
        EditorGUILayout.PropertyField(playSceneToLoad);
        EditorGUILayout.PropertyField(sandBoxSceneToLoad);
        EditorGUILayout.HelpBox("The name of the scene to load", MessageType.None);
    ...
    private void Components()
    {
        ...
        EditorGUILayout.PropertyField(loginPanel);
        EditorGUILayout.PropertyField(signUpPanel);
        ...
        EditorGUILayout.PropertyField(profileTierText);
        ...
        EditorGUILayout.PropertyField(alertBackButton);
        EditorGUILayout.PropertyField(alertQuitButton);
    }
}
